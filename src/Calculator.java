	...
	private void initialize() {
		...
		btnBackspace.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {   //working of backspace
				...
				String backSpace=null;  // This backspace removes one character to the left with the help of stringbuilder
		...
		btnSqrt.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
																					//Take text from the user 
				first=Double.parseDouble(textField.getText()); //Square root operation.and also sets the textField to just a space
				textField.setText("");
				 operation="√";
		...
		btnPlus = new JButton("+");
		btnPlus.addActionListener(new ActionListener() { //On clicking this button it gets the content of the textField and
			public void actionPerformed(ActionEvent e) {  //set it to the first and then sets the operations variable with the
				first=Double.parseDouble(textField.getText()); //addition operation.and also sets the textField to just a space
				textField.setText("");
				 operation="+";
		...
		btnSub.addActionListener(new ActionListener() { 		//set it to the firstNum and then sets the operations variable with the
		...
		btnMul.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {		//set it to the firstNum and then sets the operations variable with the
				first=Double.parseDouble(textField.getText()); 	//multiplication operation.and also sets the textField to just a space
				textField.setText("");
				 operation="*";
		...
		btnDivide.addActionListener(new ActionListener() { 		//set it to the firstNum and then sets the operations variable with the
		...
		btnPercent.addActionListener(new ActionListener() {			//On clicking this button it gets the content of the textField and
			public void actionPerformed(ActionEvent e) {			//set it to the firstNum and then sets the operations variable with the
				first=Double.parseDouble(textField.getText());		//percentage operation.and also sets the textField to just a space
				textField.setText("");
				 operation="%";
